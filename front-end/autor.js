            ...
            <div class="modal-dialog modal-lg modal-dialog-centered">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="autorModalLabel">{{modalTitle}}</h5>
...
methods:{
    ...
    addClick(){
        this.modalTitle="Adicionar Autor";
        this.id=0;
        this.nome="";
    },
    editClick(autor){
    ...
    createClick(){
        axios.post(variables.API_URL + "Autores",{
            nome:this.nome
        })
        .then((response)=>{
            this.refreshData();
    ...
    updateClick(){
        axios.put(variables.API_URL + "Autores/" + this.id,{
            id:this.id,
            nome:this.nome
        })
        .then((response)=>{
    ...
    deleteClick(id){
        ...
        axios.delete(variables.API_URL + "Autores/" + id)
        .then((response)=>{
            this.refreshData();
        })
    }
